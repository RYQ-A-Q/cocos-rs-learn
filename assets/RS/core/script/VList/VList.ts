import { _decorator, CCObject, CCString, clamp, clamp01, Component, easing, Enum, error, instantiate, Layout, log, Mask, Node, Prefab, Rect, Size, TransformBit, Tween, tween, UIOpacity, UIRenderer, UITransform, v2, v3, Vec2, Vec3, warn, Widget } from 'cc';
...
export class VList<T = any> extends Component {
    ...
    private onInitRegister() {
        log("register")
        // this.node.on(Node.EventType.SIZE_CHANGED, this.onChangeParams, this);
